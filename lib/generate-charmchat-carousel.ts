...
export const buildCharmPrompt = (
  ...
  return `You are writing a TikTok post teaching women how to text with men and providing them with texting messages. Here is the structure of your post. If content is provided, you must not change anything. If you need to fill in blanks, fill them based on the overall context of the post. Here are some examples of extremely viral post. You must learn from these posts and write a viral post. In terms of the messages generated, they must be extremely native as native English speaker and must not use any emoji.
Example 1:
{
